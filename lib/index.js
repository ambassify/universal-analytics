...
function sendHitTask(path, options, cb) {
  request.post(path, options.body, options.headers, cb);
}

var Visitor = module.exports.Visitor = function (tid, cid, options, context, persistentParams, tasks) {
  ...
  this._tasks = tasks || { sendHitTask: sendHitTask };
...
Visitor.prototype = {
  ...
  get: function (key) {
    ...
    return this._persistentParams[key];
  },
  ...
  send: function (fn) {
    ...
    var iterator = function () {
      ...
      self.get('sendHitTask').call(self, path, options, nextIteration);
    }
  ...
  _withContext: function (context) {
    var visitor = new Visitor(this.tid, this.cid, this.options, context, this._persistentParams, this._tasks);
